...
@once
    < x-data="{ imgModal : False, imgModalSrc : '' }">
        <div
            @img-modal.window="imgModal = true; imgModalSrc = $event.detail.
            imgModalSrc;"
            x-cloak
            x-transition:center="transition ease-out duration-300"
            x-transition:center-start="opacity-0 transform"
            x-transition:center-end="opacity-100 transform"
            ...
            <div @click.away="imgModal = ''" class="flex flex-col max-w-3xl max-h-full overflow-auto">
                <div class="z-50">
                    <button @click.away="imgModal = ''" class="float-right pt-2 pr-2 outline-none focus:outline-none">
